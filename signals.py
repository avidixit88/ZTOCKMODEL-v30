...
def compute_scalp_signal(
    ...
    **_ignored: object,
    ...
    early_pre_long = bool(early_pre_long or trader_edge_pre_long or scalp_reclaim_cont_long)
    early_pre_short = bool(early_pre_short or trader_edge_pre_short or scalp_reclaim_cont_short)
